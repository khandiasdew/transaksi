        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class=            $table->enum('jenis_kelamin', ['L','P']);
"form-horizontal" action="{{ route('barang.store') }}" method="POST">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <input type="text" name="nama_barang" class="form-control" id="InputNama" placeholder=""
                                    required>
                            </div>
                            <div class="form-group row">
                                <label for="Inputharga" class="col-sm-2 col-form-label">harga</label>
                                <div class="col-sm-10"></div>
                                <input type="number" name="harga_barang" class="form-control" id="Inputharga"
